...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/empty-truth#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/empty-truth
```

A live public deployment of this template is available at [https://empty-truth.templates.workers.dev](https://empty-truth.templates.workers.dev)
